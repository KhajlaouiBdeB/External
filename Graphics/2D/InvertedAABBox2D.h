...
namespace Common
{
    class InvertedAABBox2D
    {
      ...
      public:
        ...
        {
            gfx.Line((int)Left(), (int)Top(), (int)Right(), (int)Top());
            gfx.Line((int)Left(), (int)Bottom(), (int)Right(), (int)Bottom());
            gfx.Line((int)Left(), (int)Top(), (int)Left(), (int)Bottom());
            gfx.Line((int)Right(), (int)Top(), (int)Right(), (int)Bottom());

            if (RenderCenter)
            {
                gfx.Circle(m_vCenter, 5);
            }
        }
    };
