...
//          interpreter. Callers still go through RavenConfig.GetInt/GetDouble/
...
// Named RavenConfig (not "config") because raylib.h declares parameters
// literally named "config" (e.g. BeginVrStereoMode) - a macro named config
// would corrupt those declarations wherever raylib.h is parsed afterwards.
#define RavenConfig Raven::Raven_Config::Instance()
