...
namespace Raven
{
    ...
    //
    //------------------------------------------------------------------------
    Raven_Steering::Raven_Steering(Raven_Scene* world, Raven_Bot* agent)
        :

          m_pWorld(world),
          m_pRaven_Bot(agent),
          m_iFlags(0),
          m_dWeightSeparation(RavenConfig.GetDouble("SeparationWeight")),
          m_dWeightWander(RavenConfig.GetDouble("WanderWeight")),
          m_dWeightWallAvoidance(RavenConfig.GetDouble("WallAvoidanceWeight")),
          m_dViewDistance(RavenConfig.GetDouble("ViewDistance")),
          m_dWallDetectionFeelerLength(RavenConfig.GetDouble("WallDetectionFeelerLength")),
          m_Feelers(3),
          ...
          m_dWeightSeek(RavenConfig.GetDouble("SeekWeight")),
          m_dWeightArrive(RavenConfig.GetDouble("ArriveWeight")),
