    ...
    Pellet::Pellet(Raven_Bot* shooter, Vector2D target)
        :
          ...
          Raven_Projectile(target,
                           ...
                           shooter->Pos(),
                           shooter->Facing(),
                           RavenConfig.GetInt("Pellet_Damage"),
                           RavenConfig.GetDouble("Pellet_Scale"),
                           RavenConfig.GetDouble("Pellet_MaxSpeed"),
                           RavenConfig.GetDouble("Pellet_Mass"),
                           RavenConfig.GetDouble("Pellet_MaxForce")),

          m_dTimeShotIsVisible(RavenConfig.GetDouble("Pellet_Persistance"))
    {
    }
