    ...
    Bolt::Bolt(Raven_Bot* shooter, Vector2D target)
        :
          ...
          Raven_Projectile(target,
                           ...
                           shooter->Pos(),
                           shooter->Facing(),
                           RavenConfig.GetInt("Bolt_Damage"),
                           RavenConfig.GetDouble("Bolt_Scale"),
                           RavenConfig.GetDouble("Bolt_MaxSpeed"),
                           RavenConfig.GetDouble("Bolt_Mass"),
                           RavenConfig.GetDouble("Bolt_MaxForce"))
    {
