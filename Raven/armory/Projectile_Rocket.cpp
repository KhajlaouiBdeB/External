...
namespace Raven
{
    ...
    Rocket::Rocket(Raven_Bot* shooter, Vector2D target)
        :
          ...
          Raven_Projectile(target,
                           ...
                           shooter->Pos(),
                           shooter->Facing(),
                           RavenConfig.GetInt("Rocket_Damage"),
                           RavenConfig.GetDouble("Rocket_Scale"),
                           RavenConfig.GetDouble("Rocket_MaxSpeed"),
                           RavenConfig.GetDouble("Rocket_Mass"),
                           RavenConfig.GetDouble("Rocket_MaxForce")),

          m_dCurrentBlastRadius(0.0),
          m_dBlastRadius(RavenConfig.GetDouble("Rocket_BlastRadius"))
    {
    ...
    void Rocket::Update()
    {
        ...
        {
            m_dCurrentBlastRadius += RavenConfig.GetDouble("Rocket_ExplosionDecayRate");
    ...
    void Rocket::Render()
    {
        ...
        {
            gfx.HollowBrush();
            gfx.Circle(Pos(), m_dCurrentBlastRadius);
        }
    }
} // namespace Raven
