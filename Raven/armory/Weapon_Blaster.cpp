...
namespace Raven
{
    ...
    Blaster::Blaster(Raven_Bot* owner)
        :
          ...
          Raven_Weapon(type_blaster,
                       RavenConfig.GetInt("Blaster_DefaultRounds"),
                       RavenConfig.GetInt("Blaster_MaxRoundsCarried"),
                       RavenConfig.GetDouble("Blaster_FiringFreq"),
                       RavenConfig.GetDouble("Blaster_IdealRange"),
                       RavenConfig.GetDouble("Bolt_MaxSpeed"),
                       owner)
    {
    ...
    inline void Blaster::ShootAt(Vector2D pos)
    {
        if (isReadyForNextShot())
        {
            ...
            m_pOwner->GetWorld()->GetMap()->AddSoundTrigger(m_pOwner, RavenConfig.GetDouble("Blaster_SoundRange"));
        }
    }
    ...
    void Blaster::Render()
    {
        ...
        gfx.ClosedShape(m_vecWeaponVBTrans);
    }
} // namespace Raven
